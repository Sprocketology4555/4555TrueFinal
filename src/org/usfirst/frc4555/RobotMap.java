...
public class RobotMap {
    ...
    public static SpeedController lifterLifterMotors;
    public static Gyro lifterGyro1;
    ...
    public static void init() {
        ...
        lifterLifterMotors = new Talon(2);
        LiveWindow.addActuator("Lifter", "Lifter Motors", (Talon) lifterLifterMotors);
        
        lifterGyro1 = new Gyro(0);
        LiveWindow.addSensor("Lifter", "Gyro 1", lifterGyro1);
        lifterGyro1.setSensitivity(0.007);
